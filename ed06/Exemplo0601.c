...
// repetir até desejar parar
 ...
 IO_println ( "Opcoes" );
 IO_println ( " 0 - parar" );
 IO_println ( " 1 - Mostrar certa quantidade de valores/1" );
 IO_println ( " 2 - Mostrar certa quantidade de valores/2" );
 IO_println ( " 3 - Mostrar certa quantidade de valores/3 " );
 IO_println ( " 4 - Mostrar certa quantidade de valores/4 " );
 IO_println ( " 5 - Mostrar certa quantidade de valores/5 " );
 IO_println ( " 6 - Somar certa quantidade de fracoes/1" );
 IO_println ( " 7 - Somar certa quantidade de fracoes/2" );
