...
// repetir até desejar parar
 ...
 IO_println ( "13 - mostrar e contar as letras minúsculas de tras para frente." );
 ...
 default:
 IO_pause ( IO_concat ( "Valor diferente das opcoes [0,11, 12, 13] (",
