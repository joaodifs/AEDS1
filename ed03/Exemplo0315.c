...
// repetir até desejar parar
 do
 {
     system("cls");
 // identificar
 IO_id ( "EXEMPLO0315 - Programa - v0.0" );
 // ler do teclado
 IO_println ( "Opcoes" );
 IO_println ( "0 - parar" );
 ...
 break;
 default:
 IO_pause ( IO_concat ( "Valor diferente das opcoes [0,11, 12, 13, 14, 15] (",
