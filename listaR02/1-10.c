...
int main()
{
    ...
    do
    {
        ...
        IO_println("\nOpcoes:");
        IO_println("\nDigite 0 - parar");
        IO_println("Digite 1 - questao01");
        IO_println("Digite 2 - questao02");
        IO_println("Digite 3 - questao03");
        IO_println("Digite 4 - questao04");
        IO_println("Digite 5 - questao05");
        IO_println("Digite 6 - questao06");
        IO_println("Digite 7 - questao07");
        IO_println("Digite 8 - questao08");
        IO_println("Digite 9 - questao09");
